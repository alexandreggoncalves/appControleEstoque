...
### 2. Informações Gerais
 ...
 - 2.4 - Necessidades Tecnológicas e Infraestrutura de TI.
   Para o pleno desenvolvimento das atividades previstas da empresa e operacionalidade do sistema de controle de estoque, faz-se necessário a viabilidade dos seguintes recursos e tecnologias:
     ...
     ## Setor de vendas:
        - Aquisição de 04 desktops, estações de venda;
        - Aquisição de 04 impressoras térmicas;
        - Aquisição de 01 impressora Multifuncional;
        - Aquisição de 04 leitores de código de barras;
        - Aquisição de 04 NoBreak de 600VA.

      ## Setor de pagamentos (caixa):
        - Aquisição de um desktop;
        - Aquisição de uma impressora fiscal;
        - Aquisição de no mínimo 2 PDV´s (terminais de venda);
        - Aquisição de uma impressora jato de tinta;
        - Aquisição de 01 NoBreak de 600VA.
  
      ## Setor de Expedição:
        - Aquisição de 01 desktop;
        - Aquisição de 01 impressora jato de tinta;
        - Aquisição de 01 impressora térmica;
        - Aquisição de 01 Televisor de no mínimo 55” para monitoramento dos pedidos;
        - Aquisição de 01 NoBreak de 600VA.

      ## Setor de Almoxarifado (estoque):
        - Aquisição de 02 desktop;
        - Aquisição de 02 impressoras térmicas;
        - Aquisição de 01 impressora multifuncional;
        - Aquisição de 04 Terminais PDA com sistema Android;
        - Aquisição de 02 NoBreak de 600VA.
